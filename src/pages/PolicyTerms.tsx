...
const sections = [
  {
    ...
    content: (
      <Paragraph>
        ...
        <StyledLink href='mailto: asmitadk2@gmail.com'>
          miruro@proton.me.
        </StyledLink>
      </Paragraph>
    ),
  },
  {
    ...
    content: (
      <Paragraph>
        ...
        of the embedded videos remain with their respective owners. Nep Anime 
...
function PolicyTerms() {
  useEffect(() => {
    ...
    document.title = 'Policy & Terms | Nep Anime'; // Set the title when the component mounts
    return () => {
